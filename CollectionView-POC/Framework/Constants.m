...
NSString *const ICLOUD_LOGIN_REQ_MSG                = @"You must be logged into your iCloud account to submit photos and recipes or view any favorited images and recipes. Go into iCloud under Settings on your device to login.";
